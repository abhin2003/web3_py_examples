...
infura_url="https://endpoints.omniatech.io/v1/arbitrum/sepolia/public"
web3=Web3(Web3.HTTPProvider(infura_url))
print(Web3.is_connected)

#Load the ERC20 token contract using its ABI and address
...
adress="0xfb2c2196831DeEb8311d2CB4B646B94Ed5eCF684"
contract=web3.eth.contract(address=adress, abi=abi)
print(contract)

#functions to Get the token balance of an address
def get_balance(Total_balance):
    address2 = web3.to_checksum_address(Total_balance)
    balance=contract.functions.balanceOf(address2).call()
    print(balance)
    
    

addr_balance=input("Enter the adress : ")


# Validating the input
if ((addr_balance[0:2]!="0x") or (len(addr_balance)!=42)):
   print("Enter a valid adress")
else:  
    get_balance(addr_balance)
